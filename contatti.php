...
$msgs = [
    ...
    'errMsg'              => ['type' => 'danger',  'text' => 'Errore nell\'invio del messaggio. Riprova o scrivici direttamente via email.'],
];
$msg = $_GET['msg'] ?? null;
?>  
...
<main class="m-page">
    <div class="m-container">
        ...
        <div class="c-grid">
                    ...
                    <form method="POST" action="php/invia_contatti.php" style="display: flex; flex-direction: column; gap: var(--m-4);">
                        ...
                        <div class="m-field">
                            ...
                            <textarea class="m-textarea" id="messaggio" name="messaggio"
                                ...
                                required style="min-height: 140px;"><?= htmlspecialchars($_GET['messaggio'] ?? '') ?></textarea>
                        </div>
                        ...
                        <div>
                            <button type="submit" class="m-btn m-btn--primary m-btn--lg" style="width: 100%;">
            ...
            <!-- Colonna destra: info di contatto -->
            <div style="display: flex; flex-direction: column; gap: var(--m-4);">
                ...
                <div class="m-card">
                    ...
                    <div style="display: flex; flex-direction: column; gap: var(--m-2);">
                        ...
                        <a href="https://www.garanteprivacy.it" target="_blank" rel="noopener" style="display: flex; align-items: center; gap: 8px; font-size: 14px; font-weight: 500; padding: 6px 0; color: var(--m-text-soft);">
                            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"/></svg>
